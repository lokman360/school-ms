                            ...
                            <div class="box-header-title">
                                ...
                                <div class="col-md-6">
                                    <div class="box-title-center">
                                        <h3 class="text-center"><i class="fa fa-user-circle"></i> Download Exam Admit Card</h3>
                                    </div>
                                </div>
                                <div class="col-md-3"></div>
                            </div>
                            ...
                            <div class="main-content-body">
                                <div class="col-md-12">
                                   <ul class="nav nav-tabs">
                                      <li class="active"><a data-toggle="tab" href="#home">View Exam Admit Card</a></li>
                                    ...
                                    <div class="tab-content">
                                      <div id="home" class="tab-pane fade in active">
                                        ...
                                        <div class="col-md-4 col-md-offset-4">
                                          <h3 class="text-center">Exams Admit Card</h3>
                                          {{Form::open(['url'=>URL::to('download/admitcard')])}}
